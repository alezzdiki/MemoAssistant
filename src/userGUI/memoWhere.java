 ...
 * @author Alessandro
 */
public class memoWhere extends javax.swing.JFrame {

    /**
     * Creates new form memoWhere
     */
    ...
    public memoWhere(newPlanning plan) {
        initComponents();
    ...
    /**
     * Carica i preferiti nella combobox
     */
    private void fillFavCombox() {

        favorites_jComboBox.removeAllItems();
        favorites_jComboBox.addItem("");

        for (Favorites f : favoritesScreen.getFavoritesList()) {
            favorites_jComboBox.addItem(f.getDescription());
        }
    }
    ...
    /**
     * Crea il where di un/una event/action da un indirizzo
     */        
    public void createFromStreet() {

        plan.setLatJLabel(latTF.getText());
        plan.setLongJLabel(longTF.getText());
        plan.setWhereTF(addressFoundTF.getText());
    }

    /**
     * Crea il where di un/una event/action da un Google Places
     */
    public void createFromGP() {

        String where = (String) newModel.getValueAt(gpTable.getSelectedRow(), 0);
        String latitude = (String) newModel.getValueAt(gpTable.getSelectedRow(), 2);
        String longitude = (String) newModel.getValueAt(gpTable.getSelectedRow(), 3);

        plan.setWhereTF(where);
        plan.setLatJLabel(latitude);
        plan.setLongJLabel(longitude);
    }

    /**
     * Crea il where di un/una event/action da uno dei preferiti precedentemente salvati
     */
    public void createFromFavorites() {

        int i = favorites_jComboBox.getSelectedIndex() - 1;
        JOptionPane.showMessageDialog(null, "position " + i);
        Favorites fav;
        fav = favoritesScreen.getFavoritesList().get(i);
        
        plan.setLatJLabel(String.valueOf(fav.getLatitude()));
        plan.setLongJLabel(String.valueOf(fav.getLongitude()));
        plan.setWhereTF(fav.getDescription());
    }
    ...
    */
    ...
    private void initComponents() {
        ...
        favoritesRB = new javax.swing.JRadioButton();
        favorites_jComboBox = new javax.swing.JComboBox();
        jLabel8 = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Choose place for a memo");
        ...
        jPanelSfondo.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 250, 550, 120));
        ...
        jPanelSfondo.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 550, 170));
        ...
        jPanelSfondo.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 370, 550, 130));
        ...
        jPanelSfondo.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 500, 550, 50));

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Favorites", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Estrangelo Edessa", 0, 18))); // NOI18N
        jPanel1.setOpaque(false);
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        buttonGroup1.add(favoritesRB);
        favoritesRB.setToolTipText("");
        favoritesRB.setOpaque(false);
        favoritesRB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                favoritesRBActionPerformed(evt);
            }
        });
        jPanel1.add(favoritesRB, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 0, -1, 20));

        jPanel1.add(favorites_jComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 30, -1, -1));

        jPanelSfondo.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 550, 70));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userGUI/resources/sfondo 550x550.png"))); // NOI18N
        jPanelSfondo.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 550, 550));

        getContentPane().add(jPanelSfondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(1, 0, 550, 550));
        ...
        try{
           /* if ( addressFoundTF.getText().equals("No data") ||
            ...
            if (streetRB.isSelected()){
                if(!addressFoundTF.getText().equals("No data") && !addressFoundTF.getText().equals("")
                        && !addressFoundTF.getText().equals(null)){
              createFromStreet();
              ...
              this.dispose();
                ...
                createFromGP();
                System.out.println("google places");
                this.dispose();
                } else throw new Exception();
            }
            else if (favoritesRB.isSelected()){
                if(!favorites_jComboBox.getSelectedItem().toString().equals("")){
                createFromFavorites();
            ...
            //else throw new Exception("No name inserted");
        }catch (Exception ex) {
    ...
    private void googleplacesRBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_googleplacesRBActionPerformed
        ...
        favorites_jComboBox.setEnabled(false);
        addressFoundTF.setText("");
        addressTF.setText("");
        latTF.setText("");
        longTF.setText("");
    ...
    private void favoritesRBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_favoritesRBActionPerformed

        favorites_jComboBox.setEnabled(true);
        addressTF.setEnabled(false);
        find_str_Button.setEnabled(false);
        approx_addrTF.setEnabled(false);
        keywordTF.setEnabled(false);
        ...
        approx_addrTF.setText("");
        keywordTF.setText("");
    }//GEN-LAST:event_favoritesRBActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(memoWhere.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JRadioButton favoritesRB;
    private javax.swing.JComboBox favorites_jComboBox;
